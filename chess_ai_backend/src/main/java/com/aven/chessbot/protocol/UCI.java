package com.aven.chessbot.protocol;
...
/** com.aven.chessbot.protocol.UCI Protocol */
@Service
public class UCI {
  static String ENGINENAME = "AvenEngine";

  public void uciCommunication() throws MoveGeneratorException, InterruptedException {
  ...
  public Board inputPosition(String input, Board board) {
  ...
  public Move stringToMove(String input, Board board) {
  ...
  public void inputGo(Board board) throws MoveGeneratorException, InterruptedException {
  ...
  public void inputPrint(Board board) {
